    ...
    <div className="w-full min-h-screen bg-cusgray">   
      ...
      <div className="max-w-6xl mx-auto md:px-0">
        <div className="grid grid-cols-4 gap-x-6">
          ...
          <div className="col-span-4 md:col-span-4 lg:col-span-3 flex flex-col md:mx-0">
            <div className="rounded-2xl overflow-hidden shadow-lg w-full bg-white mt-6 px-5">
              <div className="mb-3">
